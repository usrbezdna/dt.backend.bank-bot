...
async def test_me_endpoint_without_verified_pn(get_access_token_for_user, already_saved_user, async_client):
    access_token = await get_access_token_for_user(already_saved_user)
    me_response = await async_client.get(path="/api/users/me", headers={"Authorization": f"Bearer {access_token}"})
...
async def test_me_endpoint_with_valid(get_access_token_for_user, already_verified_user, async_client):
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.error_case
async def test_phone_endpoint_with_unparsed_pn(get_access_token_for_user, already_verified_user, async_client):
    access_token = await get_access_token_for_user(already_verified_user)
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.error_case
async def test_phone_endpoint_with_invalid_pn(get_access_token_for_user, already_verified_user, async_client):
    access_token = await get_access_token_for_user(already_verified_user)
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.valid_case
async def test_phone_endpoint_with_valid_pn(get_access_token_for_user, already_verified_user, async_client):
    access_token = await get_access_token_for_user(already_verified_user)
...
@pytest.mark.django_db(transaction=True)
@pytest.mark.valid_case
async def test_password_endpoint_valid(get_access_token_for_user, already_verified_user, async_client):
    access_token = await get_access_token_for_user(already_verified_user)
