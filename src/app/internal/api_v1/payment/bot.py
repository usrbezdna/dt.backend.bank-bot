...
def register_telegram_payment_handlers(application: Application) -> None:
    ...
    application.add_handler(
        MessageHandler(
            filters.Regex(r"send_to_user")
            | filters.CaptionRegex(r"/send_to_user")
            | filters.Regex(r"send_to_account")
            | filters.CaptionRegex(r"/send_to_account")
            | filters.Regex(r"send_to_card")
            | filters.CaptionRegex(r"/send_to_card"),
